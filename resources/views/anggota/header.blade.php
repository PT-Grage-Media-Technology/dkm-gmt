        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
                <a class="nav-link dropdown-toggle" href="" id="userDropdown" role="button"
                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <span value="" class="mr-2 d-none d-lg-inline text-gray-600 small"></span>
                    <img class="img-profile rounded-circle" src="{{ asset('assets/images/Hewan Qurban.png') }}">
                    {{-- @if(Auth::user()->profile_anggota)
                        <img id="profileImage" src="{{ asset('storage/profile_anggota/' . Auth::user()->profile_anggota . '?' . time()) }}" alt="Profile Image" class="object-cover object-center">
                    @else
                ...
                <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                    ...
                    <a class="dropdown-item" href="{{ route('anggota.login') }}" data-toggle="modal" data-target="#logoutModal">
