...
<section class="space-y-8">
    ...
    <div class="overflow-x-auto p-4 flex items-center justify-end space-x-4 max-w-4xl mx-auto text-right">
        <form action="{{ route('rincian.notifikasi') }}" method="GET" class="flex items-center space-x-2 w-auto max-w-md ml-5">
        ...
        <a href="/notifikasi/rincian/history" class="flex items-center justify-center space-x-2 py-2 px-4 bg-blue-400 hover:bg-blue-600 text-white rounded text-center">
