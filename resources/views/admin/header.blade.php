    ...
    <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
                <a class="nav-link dropdown-toggle" href="{{route('settingadmin')}}" id="userDropdown" role="button"
                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <span value="" class="mr-2 d-none d-lg-inline text-gray-600 small">{{ $setting->nama_lengkap }}</span>
                    <img class="img-profile rounded-circle" src="{{ asset('storage/' . $setting->logo) }}">
